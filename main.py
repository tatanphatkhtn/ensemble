...
parser.add_argument('-e', help='Number of estimators: Default 20', dest='ne', action='append')
...
ne = 20
verbose = "STANDARD"
if(args.verbose): verbose = args.verbose[0]
if(args.ne): ne = int(args.ne[0])
print args.verbose
print lal_path
print unl_path
print tar_path
...
for num_of_estimators in range(2,ne):
